...
public class TintableImageButton extends ImageButton implements Themed {
    ...
    public TintableImageButton(@NonNull final Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (remoteSource != null) {
            loadRemoteResAsDrawable(context, remoteSource, new ImageUtils.LoadCallback() {
                @Override
                public void onDrawableLoaded(@NonNull final Drawable drawable) {
                    if (effectSource != null) {
                        loadRemoteResAsDrawable(context, effectSource, new ImageUtils.LoadCallback() {
                            @Override
                        ...
                        if (pressSource != null) {
                            loadRemoteResAsDrawable(context, pressSource, new ImageUtils.LoadCallback() {
                                @Override
